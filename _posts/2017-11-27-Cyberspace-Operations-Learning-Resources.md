...
Also available are links to the tools used during the course. This will allow students who have completed the course to download the open source tools used and continue their training. The Tools are and Learning Resources pages will be actively maintained via my Github. However, for those who cannot access my Github page the learning resources are detailed below (correct as at the date of this post).
